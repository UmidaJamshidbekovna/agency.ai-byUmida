    ...
    <motion.div 
        ...
        <div className='flex justify-between lg:items-center max-lg:flex-col gap-10'>
            <motion.div 
                ...
                <p className='max-w-md'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dolorem ipsum officia facere culpa repellat molestiae?</p>

                <ul className='flex gap-8'>
                    <li>
                        <a className='hover:text-primary' href="#home">Hero</a>
                    </li>
                    <li>
